...
<div style="position: fixed; bottom: 20px; right: 20px; background: #f0f0f0; padding: 10px 15px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
  <audio id="bg-music" src="https://www.youtube.com/watch?v=TCNpBpY75SQ&list=PLyjF7xdA4pUW2t9ywXyn6U_x3WbXdrLnJ&index=13" autoplay loop controls style="width: 250px;">
